...
function AlterarEquipamentoModal(id, nomeTipo, nomeModelo, identificacao, descricao) {
    ...
    SelecionarServicoDoEquipamentoCadastradoAjx(id);
    SelecionarInsumoDoEquipamentoCadastradoAjx(id);
}
...
function RemoverServicoEquipamentoModal(id, nome, id_equipamento_remover) {
    $("#id_servico_equipamento").val(id);
    $("#id_equipamento_remover_servco").val(id_equipamento_remover);
    $("#nome_servico_equipamento").html(nome);
}

function RemoverInsumoEquipamentoModal(id, nome) {
    $("#ExcluirID").val(id);
    $("#ExcluirNome").html(nome);
}
