								...
								<div class="col-xs-12">
									<h4 class="pink">
										...
										<?php if (count($servico) > 0) { ?>
											<button id="btnImprimirServ" type="button" onclick="Imprimir()" class="btn btn-purple"><i class="ace-icon fa fa-plus white"></i>Relatório</button>
										<?php } ?>
									</h4>
									<div class="table-header">
										...
										<div style="display:inline-flex" id="dynamic-table_filter">
											<input
											name="servico" id="servicos" type="search" onkeyup="FiltrarServico()" class="form-control input-sm" placeholder="buscar por serviço" aria-controls="dynamic-table">
										</div>
									</div>
															...
															<div class="hidden-md hidden-lg">
																<div class="inline pos-rel">
																	...
																	<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
																		<li>
																			<a href="#servico" role="button" onclick="AlterarServicoModal('<?= $servico[$i]['ServID'] ?>', '<?= $servico[$i]['ServNome'] ?>')" data-toggle="modal" class="tooltip-success" data-rel="tooltip" title="Edit">
																				<span class="green">
