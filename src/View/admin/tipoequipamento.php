...
<body class="skin-1">
	...
	<div class="main-container ace-save-state" id="main-container">
								...
								<div class="col-xs-12">
									<h4 class="pink">
										...
										<?php if (count($tipos) > 0) { ?>
											<button id="btnImprimirEquip" type="button" onclick="Imprimir()" class="btn btn-purple"><i class="ace-icon fa fa-plus white"></i>Relatório</button>
										<?php } ?>
									</h4>
									<div class="table-header">
										...
										<div style="display:inline-flex" id="dynamic-table_filter">
											<input name="tipo_equip" id="tipo_equip" type="search" onkeyup="FiltrarTipoEquipamentos()" class="form-control input-sm" placeholder="buscar por tipo de equipamento" aria-controls="dynamic-table">


										</div>
									</div>
									<div id="form_consultaTipoEquip">
		...
		<form id="form_consultaTipoEquip" action="tipoequipamento.php" method="post">
